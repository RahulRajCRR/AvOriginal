...
$(window).on("load", function () {
    ...
    $('#contact-form-submit').on('click', function (e) {
        let message = `${$('#contact-form')[0][3].value}

            Sincerly                            
            ${$('#contact-form')[0][0].value}                           
            ${$('#contact-form')[0][1].value}`;
        let mailtxt = `mailto:jeeva@jccinematography.in?subject=${$('#contact-form')[0][2].value}&body=${message}`

        $('#contact-form')[0][0].value = '';
        $('#contact-form')[0][1].value = '';
        $('#contact-form')[0][2].value = '';
        $('#contact-form')[0][3].value = '';
